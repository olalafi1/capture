 ...
 * Use the {@link MyTeam#newInstance} factory method to
...
public class MyTeam extends Fragment {
     ...
     * @return A new instance of fragment MyTeam.
     */
    // TODO: Rename and change types and number of parameters
    public static MyTeam newInstance(String param1, String param2) {
        MyTeam fragment = new MyTeam();
...
snapshot.getChildren()                     ) {
        ...
        view.findViewById(R.id.createteam).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(getContext(),ShowFollowing.class);
                startActivity(i);
            }
        });
    }
